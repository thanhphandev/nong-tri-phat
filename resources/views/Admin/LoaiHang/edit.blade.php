...
@section('title', 'Chỉnh sửa danh mục Loại hàng')
@section('body')
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/loai-hang" class="btn btn-primary btn-sm"><i class="fa fa-reply-all"></i> Trờ về</a> Chỉnh sửa danh mục Loại hàng</h3>
            <form action="{{ env('APP_URL') }}admin/loai-hang/update" method="post" id="dinhkemform">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="ten" name="ten" class="form-control" placeholder="Tên Loại hàng" value="{{ old('ten') != null ? old('ten') : $ds['ten'] }}" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">

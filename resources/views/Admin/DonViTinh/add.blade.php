...
@section('title', 'Thêm danh mục Đơn vị tính')
@section('body')
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/don-vi-tinh" class="btn btn-primary btn-sm"><i class="fa fa-reply-all"></i> Trờ về</a> Thêm danh mục Đơn vị tính</h3>
            <form action="{{ env('APP_URL') }}admin/don-vi-tinh/create" method="post" id="dinhkemform">
                {{ csrf_field() }}
                <div class="form-body">
                    <hr />
                    @if($errors->any())

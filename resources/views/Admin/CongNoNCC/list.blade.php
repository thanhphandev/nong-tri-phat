        ...
        <div class="col-12 col-md-12">
            <div class="row form-group">
                <div class="col-12 col-md-5">
                    <h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin" class="btn btn-info btn-sm"><i class="fa fa-reply-all"></i> Trở về</a> CÔNG NỢ NHÀ CUNG CẤP</h3>
                </div>
                <div class="col-12 col-md-7">
                    <form method="GET" action="{{ env('APP_URL') }}admin/cong-no-ncc" id="CongNoForm">
                        <div class="row form-group">
                            <div class="col-12 col-md-9">
                                <select name="id_nhacungcap" id="id_nhacungcap" class="form-control select2" data-placeholder="Chọn Nhà cung cấp">
                                    <option value=""></option>
                                    @foreach($nhacungcap as $ncc)
                                        <option value="{{ $ncc['_id'] }}" @if($ncc['_id'] == $id_nhacungcap) selected @endif>{{ $ncc['dien_thoai'] }} - {{ $ncc['ma'] }} - {{ $ncc['ten'] }}</option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <form action="{{ env('APP_URL') }}admin/cong-no-ncc/thanh-toan" method="POST" id="ThanhToanForm">
                <div class="card-box">
                    <div class="row form-group">
                        ...
                        <input type="hidden" name="id_nhacungcap" id="id_nhacungcap" value="{{ $id_nhacungcap }}" placeholder="">
                        <div class="col-12 col-md-3">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a href="#messages" data-toggle="tab" aria-expanded="false" class="nav-link">
                                    <i class="fas fa-money-check-alt"></i> <span class="d-none d-sm-inline-block ml-2">Lịch sử Nợ/Nhập hàng</span>
                                </a>
                            </li>
                        </ul>
